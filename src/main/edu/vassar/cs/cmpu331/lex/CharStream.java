...
import edu.vassar.cs.cmpu331.errors.LexicalError;
...
public class CharStream
{
    ...
    *
    * @see edu.vassar.cs.cmpu331.errors.LexicalError
    */
   ...
   public CharStream(URL url) throws IOException
   {
      super();
      open(getReader(url));
   }
    ...
    */
   public boolean open(BufferedReader reader)
   {
      try
      {
         this.reader = reader;
